...
if __name__ == "__main__":
    ...
    #     FileInput(
    #         file_path=r"C:\Users\emers\OneDrive\Área de Trabalho\Itaú\CICF\DataCraft\Verificador Inteligente de Obras\codes\construct-cost-ai\data\inputs\orcamentos\sample_padrao1 - AG 0605 - 103481.xlsx",
    #     )
    # )
